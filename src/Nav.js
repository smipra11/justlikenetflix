...
function Nav(){
    ...
    return(
        <div className={`nav ${shown && "nav_black"} `}> 
        ...
        <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRqeBwNIKXsYKRWYD7EBOFSb0j-7k-yNySO9g&usqp=CAU" alt="" className="nav_avatar"/>
